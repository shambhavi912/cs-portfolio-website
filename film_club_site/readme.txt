...
2. I have used a very basic black and white colour scheme in order for my website to be accessible to any user who might have slightly impaired vision or colour blindness.
3. The alt attribute for the images is used to make my website more accessible for when the user might use a screen reader when accessing my website.

<!-- State 3 ways in which you have considered usability in your site. -->
1. My website is usable in the sense that I have made it responsive for different screen sizes. This allows for my users to access my website on virtually any device.
2. I have created a consistent layout and design throughout my website to keep the website’s users’ minds at ease. By making my website’s design consistent, I am able to make it look coherent and work harmoniously across the different pages and elements.
3. I have restricted the use of text on my homepage and used more images in order to attract users. This makes my website more usable since users will not be turned away by the abundance of text on the homepage.
...
[3] W3Schools.com, ‘Responsive Top Nav Reference’, [Online]. Available: https://www.w3schools.com/howto/tryit.asp?filename=tryhow_js_topnav

[4] AegeanDelight.com, 'Authentic Turkish Delight Recipe' [Online]. Available: https://aegeandelight.com/authentic-turkish-delight-recipe-from-narnia/

[5] Vogue.in, 'Decoding Every Outfit On Euphoria Season 2'[Online]. Available: https://www.vogue.in/fashion/content/decoding-every-outfit-on-season-2-of-euphoria

[6] LATimes.com, 'Tick, Tick... Boom Review'[Online]. Available: https://www.latimes.com/entertainment-arts/movies/story/2021-11-12/tick-tick-boom-review-andrew-garfield-lin-manuel-miranda

[7] MarieClaire.com, 'Musical Movies' [Online]. Available: https://www.marieclaire.com/culture/g4045/musical-movies/

[8] TheTravel.com, 'Best Movie Locations Worth Travelling To'[Online]. Available: https://www.thetravel.com/best-movie-locations-worth-traveling-to/
